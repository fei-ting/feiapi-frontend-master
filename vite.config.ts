  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        'src/features/interface-platform/documentation/components/**': coreCoverageThresholds,
        'src/features/interface-platform/documentation/views/InterfaceDocMaintenanceView.vue': coreCoverageThresholds,
        ...
        'src/features/interface-platform/documentation/components/InterfaceDocumentation.vue': coreCoverageThresholds,
