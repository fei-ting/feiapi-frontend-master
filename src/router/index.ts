  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'interfaces/:id/document', name: 'admin-interface-doc', component: () => import('@/features/interface-platform/documentation/views/InterfaceDocMaintenanceView.vue'), meta: { feature: 'admin-interface-doc' } },
